    ...
    return Scaffold(
      body: Stack(
        children: [
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Window/Section display (sample data - will be replaced with server data)
                        Container(
                          ...
                          child: Text(
                            'Window 1', // Sample data - replace with actual window/section from server
          ...
          // Warning button and theme customizer button at top right
          Stack(
            children: [
              // Warning button on the left
              Align(
                ...
                child: SafeArea(
                  child: Padding(
                    padding: const EdgeInsets.only(
                      top: EZSpacing.sm,
                      right: 56, // Position to the left of theme button
                    ),
                    child: IconButton(
                      onPressed: () {
              ...
              // Theme customizer button on the right
